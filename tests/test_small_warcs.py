...
warcs = {'alexa_short_header.arc.gz':      'net,killerjo)/robots.txt 20110804181142 http://www.killerjo.net:80/robots.txt unk - YZI2NMZ5ILYICUL3PNYVYQR3KI2YY5EH - - 139 161 alexa_short_header.arc.gz',
         ...
         # Empty HTTP payload, header ends with single "\r\n"
         'transposed_header.arc.gz':       'com,mp3,play)/cgi-bin/play/play.cgi/aaiaqo93mqdabg5vcm1qbaaaafj88quauqeaaabdnyyxp6sbry55rya.wo2ewl.61xo-/losing_time.mp3 20031219215023 http://play.mp3.com/cgi-bin/play/play.cgi/AAIAQo93MQDABG5vcm1QBAAAAFJ88QUAUQEAAABDNyyxP6SbRY55RYa.wO2ewL.61xo-/Losing_Time.mp3 text/plain 302 3I42H3S6NNFQ2MSVX7XZKYAYSCX5QBYJ - - 347 163 transposed_header.arc.gz', #from MP3-CRAWL-crawl05.20031219201259-c/MP3-CRAWL-crawl05.20031219215024.arc.gz
